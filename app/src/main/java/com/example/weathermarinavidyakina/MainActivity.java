package com.example.weathermarinavidyakina;
        ...
        search_floating.setOnClickListener(new View.OnClickListener() {
            ...
            private void api_key(final String City) {
                ...
                Request request = new Request.Builder()
                        .url("https://api.openweathermap.org/data/2.5/weather?q="+City+"&appid=662ea40fd96535eaf8f185c6348f6668&units=metric")
                        .get()
                        .build();
